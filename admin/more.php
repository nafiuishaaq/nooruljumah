...
<?php $file = new files (); ?>       
        <?php if($file->getFile($id = $_GET['file_id'])) : ?>
            ...
            <div class="card-header">File Details <button class="btn btn-link float-right"><i class="fa fa-bars"></i></button></div> 
                <div class="card-img-fluid"> <!--card-img-fluid begin-->

                 <?php
            if($file['file_image'] == ""){
                ?>
               <img class="details-img-resize" src="upload/files/default.jpg">
               <?php 
            }else{
                 ?>
                  <img class="details-img-resize " src="upload/files/<?= $file['file_image'];?>" alt="">
            <?php 
            }
            ?>
                ...
                <div class="card-title m-3"> <!--card-title begin-->
                  ...
                  <i class="text-primary">Date Created:</i> <?= $file['date']; ?><br><hr>
                 ...
                 <button type="button" data-toggle="modal" data-target="#Model" class="m-1 btn btn-danger btn-circle btn-sm float-right"><i class="fa fa-trash"></i>
                  ...
                  <!--edit btn-->
                <form action="scholar_file_edit.php" method="post">
        <input type="hidden" name="file_edit_id" value="<?= $file['file_id']; ?>" id="f_id">
        <button type="button" data-toggle="modal" data-target="#Mode2" class="m-1 btn btn-danger btn-circle btn-sm float-right"><i class="fa fa-trash"></i>
        </button>
